...
return new AdminerDesigns(
	$designs = [
        ...
        "../designs/pepa-linha-dark/adminer.css" => "pepa-linha-dark",
        ...
        "../designs/rmsoft-blue/adminer.css" => "rmsoft-blue",
        "../designs/rmsoft-dark/adminer.css" => "rmsoft-dark",
        "../designs/adminer-dark/adminer-dark.css" => "adminer-dark",
        "../designs/michael-grznar/adminer.css" => "michael-grznar",
        "../designs/ichier/adminer.css" => "ichier",
        "../designs/filametish/adminer.css" => "filametish",
        "../designs/mancave/adminer-dark.css" => "mancave",
        "../designs/galkaev/adminer-dark.css" => "galkaev",
        "../designs/dracula/adminer-dark.css" => "dracula",
        "../designs/cocoa/adminer.css" => "cocoa",
        "../designs/simple-theme/adminer.css" => "simple-theme",
        "../designs/arcs-material/adminer.css" => "arcs-material",
        ...
        "../designs/arcs-/adminer.css" => "arcs-",
        "../designs/konya/adminer.css" => "konya",
        "../designs/kahi/adminer.css" => "kahi"
    ]
);